...
public class Human {
  ...
  private boolean isWorking; // 주문이 완료되었는지 안되었는지를 나타내는 상태
  ...
  private boolean ramens; // 라면을 다 먹었는지 안먹었는지를 비교합니다.
    ...
    public void orderRamens() {
        ...
        if(isSitting){
            ...
            System.out.println("자리에 앉지 못했습니다.... 자리에 앉아주세요...");
        }

    }

    public void rameHots() {
        if (isWorking) {
            System.out.println("라면을 주문하지 못했습니다... 라면을 주문해주세요.");
